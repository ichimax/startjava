...
Вы решили начать изучать язык программирования Java и, возможно, в будущем хотели бы пройти обучение на наших [курсах](https://topjava.ru/) и получить достойную профессию Java-разработчика!
Но знаний еще не хватает и [выполнить](https://drive.google.com/file/d/1W9AtOE3yvDCOOZxmHSw4lGpFiFVYJB8_/view?usp=sharing) первое открытое домашнее задание на курсе [BaseJava](https://topjava.ru/basejava) не получается...

Что бы помочь вам начать программировать, наша команда разработала новый бесплатный курс — StartJava.

Все уроки содержат ссылки на дополнительные материалы, а также наши авторские видео.
В каждом уроке есть дз, которое позволит вам закрепить изученные темы.
...
## Рекомендуемые книги
 ...
 - [Книга для детей: Яша учится программировать](https://drive.google.com/file/d/0B4aqdlQNObcpRU4xbElnQnBsR0E/edit)
