...
- Модифицируйте программу `Калькулятор`:  
  ...
  - для преобразования аргументов выражения из `String` в `int` используйте метод [`Integer.parseInt()`](https://javarush.ru/groups/posts/2743-rukovodstvo-po-klassu-java-integer)
