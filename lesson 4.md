...
- Модифицируйте программу `Калькулятор`, используя для хранения значений мат.выражения массивы  
- Модифицируйте программу `Угадай число`, используя для хранения количества игроков массивы  

## Советы для тех, кто выполняет домашнее задание
- Пример формата ввода мат.выражения:  `2 + 3`
- Для сохранения элементов мат.выражения в массив используйте метод класса String split();
- Запрашивайте у пользователя количество игроков
- Созданных игроков поместите в массив
