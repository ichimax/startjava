...
- Задание со * (выполняйте любые его пункты по желанию, либо проигнорируйте):
  - делайте проверку в сеттере для сохранения числа в массив, что игроки вводят числа в необходимом диапазоне. Не сохраняйте в массив числа, выходящие за его пределы
