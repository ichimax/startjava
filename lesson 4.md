...
- Модифицируйте программу `Калькулятор`, используя для хранения значений математического выражения массивы:
  - воспользуйтесь методами класса [`Math`](http://java-help.ru/java-lang-math/), какие только сможете найти, заменив ими ваши реализации, связанные с вычислениями
  - для сохранения элементов математического выражения используйте метод класса `String.split()`;
- Модифицируйте программу `Угадай число`, используя для хранения, названных игроками при каждой попытке чисел, массивы:
  ...
  - в конце игры выведите сообщение `"Игрок по имени " + имя + " угадал, загаданное компьютером число " + число + "с " + номер попытки`
  - если игроки не угадали число за 10 попыток, то отобразите сообщение: `Попытки закончились. Вы не отгадали`
...
- Пример формата ввода мат.выражения:  `2 + 3`
