...
Также вы можете выполнить [выпускной проект](https://docs.google.com/document/d/1IAiDJmSAD86P-xTp3kOs-tFFuDQViXRewI-vpk1nT3g/edit?usp=sharing). Делайте его по желанию. Это пока что не обязательная опция, но в будущем все изменится.
...
- **Не приступайте к заданиям со звездочкой, пока не сдадите основную часть ДЗ**
...
- *Задание со * (выполняйте любые его пункты по желанию, либо проигнорируйте):*
  ...
  - используйте новый `switch expression`([1](https://dev.java/learn/branching-with-switch-expressions/), [2](https://youtu.be/uNJTkppQEZQ))
...
- *Задание со * (выполняйте любые его пункты по желанию, либо проигнорируйте):*
  - реализуйте проверку чисел на > и < с помощью тернарного оператора. При этом дублирования текста в сообщениях быть не должно
  - реализуйте проверку, сохраняемого в массив числа, на вхождение в диапазон (0, 100]. Не сохраняйте в массив числа, выходящие за его пределы. Делайте это в сеттере 
...
- [Итоговый тест](https://forms.gle/gqgWh3wh1WbWKBWx7) позволит вам проверить, насколько хорошо вы осовили пройденные темы
