...
1. [Опросники](#7)
1. [Советы по выполнению домашнего задания](#8)
...
> Перед отправкой домашнего задания на проверку обращайте внимание на [`Советы по выполнению домашнего задания`](https://github.com/ichimax/startjava/blob/master/lesson%202.md#7-советы-по-выполнению-домашнего-задания), которые содержат ряд полезных подсказок и разъяснений
...
- Модифицируйте программу `Угадай число`:
  ...
  - ход к следующему игроку переходит только тогда, когда текущий не угадал число
...
- В этом небольшом [опроснике](https://forms.gle/YDyNWaaf7SssGEtAA) вы сможете поделиться своими впечатлениями (анонимно) по поводу второго урока: что (не)понравилось, как его можно улучшить и тд. Ваши ответы помогут нам доработать урок, сделав его еще лучше!
 ...
 ## 8. <a name="8">Советы по выполнению домашнего задания</a>
 ...
 1. Если Scanner пропускает ввод с клавиатуры и не дает его сделать, то ознакомьтесь с [этой статьей](https://ru.stackoverflow.com/questions/526818/scanner-%D0%BD%D0%B5-%D1%81%D1%87%D0%B8%D1%82%D1%8B%D0%B2%D0%B0%D0%B5%D1%82-%D1%81%D1%82%D1%80%D0%BE%D0%BA%D1%83-%D0%BF%D0%BE%D1%81%D0%BB%D0%B5-nextint)
