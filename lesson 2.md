...
- Модифицируйте программу `Угадай число`:
 ...
 1. Для ввода данных используйте клавиатуру (класс [`Scanner`](https://vertex-academy.com/tutorials/ru/rabota-so-skannerom-v-java/))
 ...
 1. Для завершения или продолжения работы программ выводите сообщение: `"Хотите продолжить? [да/нет]: "`
 1. Если пользователь ввел ни "да" ни "нет", а что-то другое — снова выведите сообщение из п.5
