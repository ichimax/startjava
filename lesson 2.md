...
- Создайте программу, описывающую любого из представленных типов [роботов](http://pacificrim.wikia.com/wiki/Category:Jaegers)
 ...
 6. Если пользователь ввел ни "да" ни "нет", а что-то другое — снова вывести сообщение из п.5
 7. Примерно так должна выглядеть структура ваших файлов и папок ![tree](https://user-images.githubusercontent.com/29703461/40489227-4cd9ede0-5f71-11e8-952a-0c8e828814fc.png)
 ...
 9. Не забывайте указывать для полей и методов модификаторы доступа
