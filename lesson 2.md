...
- Модифицируйте программу `Калькулятор`:
  ...
  - для завершения или продолжения работы программы `Калькулятор`, выводите сообщение: `"Хотите продолжить вычисления? [да/нет]:"`. Выводите его до тех пор, пока не будет введено "да" или "нет" (реализуйте эту логику в `CalculatorTest`)
