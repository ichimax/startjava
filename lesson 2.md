...
- Модифицируйте программу `Угадай число`:
 ...
 1. Как, используя класс Scanner, получить тип данных char?
 
 например, [так](https://stackoverflow.com/questions/23098790/how-can-i-enter-char-using-scanner-in-java):
