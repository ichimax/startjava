...
- Модифицируйте программу `Калькулятор`:
  - создайте класс `CalculatorTest`, перенеся в него метод main 
  - класс `Calculator` будет содержать код, отвечающий за проверку математического знака и вычисления
...
- Модифицируйте программу `Угадай число`:
  ...
  - имена игроков вводите с клавиатуры перед стартом игры, а затем передавайте их в конструктор, создаваемых экземпляров Player
  - созданных игроков передавайте в игру через ее конструктор
