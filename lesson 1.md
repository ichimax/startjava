...
4. Что бы форматирование вашего кода на GitHub выглядело корректно, воспользуйтесь [этими](https://superuser.com/questions/1048772/default-sublime-text-3-to-use-spaces-instead-of-tabs) рекомендациями
