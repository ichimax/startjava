...
- Что бы табуляция при форматировании вашего кода на GitHub выглядела корректно, воспользуйтесь [этими](http://gearmobile.github.io/sublime-text-tabulation/) рекомендациями (стандарт — один tab равен 4 пробела). Смотрите раздел *Редактирование файла конфигурации Sublime Text*
