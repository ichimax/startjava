...
![error](https://user-images.githubusercontent.com/29703461/39296698-4796325e-494a-11e8-8ac5-53cf4b3c3e6d.jpg)
то
...
- Реализуйте калькулятор, который должен уметь выполнять следующие математические операции: `+, -, *, /, ^, %`
...
- `git add перечислить_через_пробел_файлы,_которые_надо_занести_в_git.java` (файлы с расширением class не заносить)
- `git commit -m "описание изменений, которые вы сделали в программе"`
