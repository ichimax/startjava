...
4. Что бы форматирование вашего кода на GitHub выглядело корректно, воспользуйтесь [этими](http://gearmobile.github.io/sublime-text-tabulation/) рекомендациями
